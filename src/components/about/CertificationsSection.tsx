    ...
    <section className="py-12 px-4 sm:px-6 pb-24">
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <span className="text-[10px] sm:text-xs font-mono text-muted uppercase tracking-widest">
        ...
        {certifications.length > initialCount && (
          ...
          >
            <button
              ...
              className="group flex items-center gap-2 px-8 py-2.5 sm:px-10 sm:py-3 bg-transparent hover:bg-primary/5 text-muted hover:text-primary text-sm sm:text-base font-bold rounded-full border border-border hover:border-primary/50 transition-all duration-300 active:scale-95"
            >
              {isExpanded ? (
                <>
