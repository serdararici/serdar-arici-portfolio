...
const BlogsComingSoon = () => {
  return (
    <div className="min-h-[90vh] bg-background text-foreground flex flex-col items-center justify-center px-6 relative overflow-hidden">
      ...
      {/* Background Glow - Arka planda hafif bir parıltı */}
      ...
      <main className="max-w-6xl w-full grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative z-10">
        ...
        >
          ...
          <h1 className="text-5xl md:text-7xl font-extrabold tracking-tight leading-tight">
            The Blog is <br />
            <span className="text-[var(--color-primary)]">Compiling...</span>
          </h1>

          <p className="text-gray-400 text-lg max-w-lg mx-auto lg:mx-0 leading-relaxed">
            I'm currently curating deep-dive articles on software architecture, 
            system design patterns, and engineering insights. Stay tuned for the release.
          </p>
          ...
          <p className="text-xs text-gray-600 italic">No spam. Unsubscribe at any time.</p>
        </motion.div>

        {/* Sağ Taraf: İllüstrasyon (Kod Bloğu Görünümü) */}
        <motion.div
...
// High performance delivery.`}
      ...
      {/* Footer Nav Links (Görseldeki gibi alt kısım) */}
      <footer className="mt-auto py-12 flex flex-col items-center gap-8 w-full border-t border-gray-900/50">
        <nav className="flex gap-8 text-sm font-medium text-gray-500">
          ...
          <a href="/blogs" className="text-[var(--color-primary)]">Blogs</a>
        ...
        <p className="text-[10px] text-gray-700 uppercase tracking-[0.2em]">
          © 2024 Serdar Arıcı. Built with precision.
        </p>
      </footer>
    </div>
  );
