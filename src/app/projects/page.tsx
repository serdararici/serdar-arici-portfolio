              ...
              <AnimatePresence>
                {filtered.map((project: Project) => (
                  <motion.article
                    ...
                    className="relative group bg-card border border-gray-800 rounded-[2.5rem] overflow-hidden shadow-lg transform transition hover:scale-[1.02] hover:border-primary/50"
                  >
                    <div className="flex flex-col md:flex-row w-full">
                      {/* Left: Image */}
                      <figure className="relative w-full md:w-96 h-64 md:h-auto shrink-0 overflow-hidden md:rounded-l-[2.5rem] rounded-t-[2.5rem]">
                        <Image
                          src={project.image}
                          alt={project.title}
                          fill
                      ...
                      <div className="p-6 flex flex-col gap-3 flex-1 md:pl-6">
                        {/* Title */}
                        <div>
                          <h3 className="text-2xl md:text-4xl font-bold text-foreground truncate">
                            {project.title}
                          </h3>
                        </div>

                        {/* Description */}
                        <p className="text-l text-gray-300 line-clamp-5 leading-relaxed pr-4 md:pr-6 overflow-hidden">
